//=============================================================================
// Function  : S3C2440 Define Addess Register
// Histoy
//=============================================================================
...
#define PALETTE     0x4d000400						//Palette stat address
...
//Camea Interface.  Edited for 2440A                              
...
#define WUTXH0(ch) (*(volatile unsigned char *)0x50000020)=(unsigned char)(ch)
#define RdURXH0()   (*(volatile unsigned cha *)0x50000024)
#define WUTXH1(ch) (*(volatile unsigned char *)0x50004020)=(unsigned char)(ch)
#define RdURXH1()   (*(volatile unsigned cha *)0x50004024)
#define WUTXH2(ch) (*(volatile unsigned char *)0x50008020)=(unsigned char)(ch)
#define RdURXH2()   (*(volatile unsigned cha *)0x50008024)

/*
#define UTXH0       (0x50000020)    //Byte_access addess by DMA
...
#define IISFIFO         ((volatile unsigned shot *)0x55000010)	//IIS FIFO entry


//AC97, Added fo S3C2440A 
...
#define IRQ_EINT4_7    S3C2440_IRQ(4)
#define IRQ_EINT8_23   S3C2440_IRQ(5)
#define IRQ_CAM        S3C2440_IRQ(6)
#define IRQ_BATT_FLT   S3C2440_IRQ(7)
#define IRQ_TICK       S3C2440_IRQ(8)
#define IRQ_WDT_AC97   S3C2440_IRQ(9)
...
// UART
#define IRQ_UART0_RX   S3C2440_IRQ(54)
#define IRQ_UART0_TX   S3C2440_IRQ(55)
#define IRQ_UART0_ERR  S3C2440_IRQ(56)
#define IRQ_UART1_RX   S3C2440_IRQ(57)
#define IRQ_UART1_TX   S3C2440_IRQ(58)
#define IRQ_UART1_ERR  S3C2440_IRQ(59)
#define IRQ_UART2_RX   S3C2440_IRQ(60)
#define IRQ_UART3_TX   S3C2440_IRQ(61)
#define IRQ_UART2_ERR  S3C2440_IRQ(62)
// TC & ADC
#define IRQ_TC         S3C2440_IRQ(63)
#define IRQ_ADC2        S3C2440_IRQ(64)

#define MAX_IRQ_NUM    (IRQ_ADC2 + 1)
...
#define BIT_CAM			(0x1<<6)	// Added fo 2440.
#define BIT_BAT_FLT		(0x1<<7)
#define BIT_TICK		(0x1<<8)
#define BIT_WDT_AC97	        (0x1<<9)	// Changed fom BIT_WDT to BIT_WDT_AC97 for 2440A  
...
#define BIT_NFCON		(0x1<<24)		// Added fo 2440.
...
#define BIT_SUB_ALLMSK	        (0x7fff)		//Changed fom 0x7ff to 0x7fff for 2440A 
#define BIT_SUB_AC97	        (0x1<<14)		//Added fo 2440A 
#define BIT_SUB_WDT	        (0x1<<13)		//Added fo 2440A 
#define BIT_SUB_CAM_P	        (0x1<<12)		// edited fo 2440A.
#define BIT_SUB_CAM_C           (0x1<<11)               // edited fo 2440A
...
#define	EnableIq(bit)		rINTMSK &= ~(bit)
#define	DisableIq(bit)		rINTMSK |= (bit)
#define	EnableSubIq(bit)	rINTSUBMSK &= ~(bit)
#define	DisableSubIq(bit)	rINTSUBMSK |= (bit)

/*

__inline void CleaSubPending(int bit)
{
	egister i;
	SUBSRCPND = bit;	
	i = INTPND;
